var size = 0;
var placement = 'point';
function categories_DDV_002_3(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case 'POR DEFINIR':
            return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(23,94,243,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 4.4079999999999995}),fill: new ol.style.Fill({color: 'rgba(23,94,243,0.5019607843137255)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
...
var style_DDV_002_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_DDV_002_3(feature, value, size, resolution, labelText,
