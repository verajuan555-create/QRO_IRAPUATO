var size = 0;
var placement = 'point';
function categories_DDV_V001_5(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement, textAlign, offsetX, offsetY, overflow, repeat) {
    var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
    switch(valueStr) {case 'EN PROCESO':
...
var style_DDV_V001_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_DDV_V001_5(feature, value, size, resolution, labelText,
